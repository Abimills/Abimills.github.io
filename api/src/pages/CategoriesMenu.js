...
indvContainer.addEventListener('click',()=> fetchIndividualFood(
    food.strMeal,
    food.strArea,food.strMealThumb,food.strCategory, food.strIngredient1,
     food.strIngredient2,
...
CategoryDiv.classList.add('category-containers')
